...
import com.pandaapps.medicalstoremangementsystem.Components.DialogBoxWithProgressIndicator
import com.pandaapps.medicalstoremangementsystem.Components.DialogWithImage
...
@Composable
fun SignUp(viewModel: ViewModelSignupScreen) {
    ...
    when (viewModel.state.value) {
        ...
        State.SUCESS.stateType -> {
            Text(text = "Account Created Navigate to Other Screen")
        }
